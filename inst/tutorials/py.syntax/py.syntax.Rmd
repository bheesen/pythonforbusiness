...
Die wichtigsten elementaren Datentypen in Python sind: **Float (float)** sind Gleitkommazahlen, wobei das Dezimalkomma in Python standardmäßig durch einen Punkt ein- und ausgegeben wird. **Integer (int)** sind ganzzahlige Zahlenwerte und verbrauchen weniger Speicherplatz als der Typ Float.	**Boolean (bool)** sind logische Werte, welche True oder False sein können.	**String (str)** sind Zeichenketten bzw. Strings und werden entweder in einfache ' ' oder doppelte " " Anführungszeichen gesetzt.
...
n3=round(n1,2)                   # Runden auf 2 Nachkommastellen
n3                               # Variableninhalt
n1,n2,n3
print(n1,n2,n3)
...
s1print+="ist die Zahl "+str(n3) # Keine Fehlermeldung, da String
print(s1print)
